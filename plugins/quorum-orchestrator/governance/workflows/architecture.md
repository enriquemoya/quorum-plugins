...
Input: slug. Agent: `quorum-architecture`. Precondition: status DRAFTING_SPEC.
...
4) Write architecture.md. Every stack fact resolves from the profile; nothing is assumed.
5) Transition to DRAFTING_ARCH through `quorum-status`.
