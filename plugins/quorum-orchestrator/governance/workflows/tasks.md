...
Input: slug. Agent: `quorum-tasks`. Precondition: status DRAFTING_SPEC, DRAFTING_DESIGN or ANALYZING.
...
4) Write tasks.md. Every stack fact resolves from the profile; nothing is assumed.
5) Transition to DRAFTING_TASKS through `quorum-status`.
