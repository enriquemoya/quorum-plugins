...
Input: slug. Agent: `quorum-prd`. Precondition: status DRAFT_PRD.
...
4) Write prd.md. Every stack fact resolves from the profile; nothing is assumed.
5) Transition to PRD_READY through `quorum-status`.
