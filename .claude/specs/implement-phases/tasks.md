...
- [ ] T1: one argument, one flag set — files: plugins/quorum-orchestrator/commands/quorum-implement.md — AC: AC1, AC2
...
- [ ] T2: complexity is read, not re-derived — files: plugins/quorum-orchestrator/commands/quorum-implement.md — AC: AC4
...
- [ ] T3: replace fetch and plan with reading the unit — files: plugins/quorum-orchestrator/commands/quorum-implement.md — AC: AC3, AC7
      Both become reads of the spec artifacts, with `tasks.md` as the plan. The
      prompt file is kept and is the whole keep-set.

- [ ] T4: renumber, and state the new gate count — files: plugins/quorum-orchestrator/commands/quorum-implement.md — AC: AC3, AC5
...
- [ ] T5: roles, not products — files: plugins/quorum-orchestrator/commands/quorum-implement.md — AC: AC6
...
- [ ] T6: assert the guarantees — files: scripts/e2e.py — AC: AC8
...
- [ ] T7: run both suites — files: (gate; no source changes) — AC: AC8
