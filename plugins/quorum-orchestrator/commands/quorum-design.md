---
argument-hint: "<slug>"
description: Stage 4 of the governed pipeline. Produces design.md — flows, complete contracts, schema and indexes, edge cases and states. Invoked by /quorum-orchestrate; reads the profile for every stack fact.
---

# /quorum-design

Produces `design.md`. Runs on DRAFTING_ARCH.

## Process

1. Delegate to the **quorum-design** agent.
...
4. It writes `design.md` and transitions to `DRAFTING_DESIGN` through `quorum-status`.
