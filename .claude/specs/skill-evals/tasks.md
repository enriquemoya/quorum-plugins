...
- [x] T1: record the eval format — files: (read-only) — AC: AC1
...
- [x] T2: evals for quorum-status — files: plugins/quorum-orchestrator/skills/quorum-status/evals/evals.json — AC: AC1, AC2, AC3, AC5
...
- [x] T3: evals for quorum-panel — files: plugins/quorum-orchestrator/skills/quorum-panel/evals/evals.json — AC: AC1, AC2, AC3, AC5
...
- [x] T4: evals for quorum-init — files: plugins/quorum-orchestrator/skills/quorum-init/evals/evals.json — AC: AC1, AC2, AC3, AC5
...
- [x] T5: run both suites — files: (gate; no source changes) — AC: AC4
